...
/**
 * Extends class Animal and implements Swimmer to represent a dolphin
 *
 * @author andrzejcalka
 * @author =-_-=
 */
public class AnimalDolphin extends Animal implements Swimmer {
     ...
     */
    public AnimalDolphin(String breedOrType, String name, int yearOfBirth) {
